...
begin
  ...
  return jsonb_build_object(
    ...
    'owner_url',case when v_slug is null then
      'https://app.taphoa.xyz/kiemhang/?t='||v_owner.token::text
    else
      'https://app.taphoa.xyz/kh/?kh='||v_slug||'&tab=kiemhang&t='||v_owner.token::text
    end
  );
end;
$$;
