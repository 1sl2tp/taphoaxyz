-- Show useful supermarket products immediately when the quick-search field is empty.
-- Empty query returns recently updated products; typed queries keep name relevance + price sorting.
