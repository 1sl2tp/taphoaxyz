...
test('share image capture is on-demand bounded and lighter on Safari-sized pages',async()=>{
  ...
  assert.ok(html.indexOf('fixed-ui-share-capture.js?v=iphone-share-20260921') < html.indexOf('fixed-ui-runtime-10.js?v=soft-order-colors-20260921'));
  ...
  assert.ok(html.indexOf('fixed-ui-ios-share-fallback.js?v=ios-pwa-preview-20260921') < html.indexOf('fixed-ui-runtime-10.js?v=soft-order-colors-20260921'));
